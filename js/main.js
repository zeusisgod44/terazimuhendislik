...
// Menü dışına tıklayınca hamburger menüyü kapat
document.addEventListener('click', (e) => {
...
// Menü içindeki linke tıklayınca sadece hamburger menüyü kapat
navLinks.querySelectorAll('a').forEach(link => {
    link.addEventListener('click', (e) => {
        // Eğer bu link "Hizmetler" butonuysa kapatma!
